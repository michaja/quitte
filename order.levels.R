# order.levels.R   ensure a given order for factor levels 
# ----------------------------------------------------------------------------- 
# input:  df                - a data frame 
#         ...               - name-value pairs assigning level order to factors
#         drop.extra.levels - boolean to drop levels which are not present in 
#                             the current factor
# output: a data frame 
# ----------------------------------------------------------------------------- 
